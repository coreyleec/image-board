...
const TsCommunityContent: React.FC<IProps> = (props) => {
...
{props.mobile ?
          ...
          {props?.catagory?.map((user, n) => (
            ...
            >
              ...
              <UserCard identifier={user.uuid} onClick={() => props.fetchUser(user.uuid, user.name, null)}>
        ...
        {user.photos.map(photo => 
            ...
            <div className="text-cont">
              ...
              {(user.name !== photo.user_name) && <p className="user-name" onClick={() => props.fetchUser(photo.u_id, photo.user_name, photo.folder_id)} >by {photo.user_name}</p>}
              <Console log='Success' />

              {/* {console.log("user name", user?.name, photo?.user_name, photo?.name) ?? null} */}
...
export default TsCommunityContent
